...
int main () {
    ...
    cout << "The acsc is: " << "NAN" << "\n";
    cout << "The asec is: " << asec(a) << "\n";
    cout << "The acot is: " << acot(a) << "\n\n";
    cout << "asec Rounded to 2 decimal places: " << asec(a).rnd(2) << "\n";
    cout << "The cosh is: " << cosh(a) << "\n";
    cout << "The tanh is: " << "NAN" << "\n";
    cout << "The csch is: " << "NAN" << "\n";
    cout << "The sech is: " << "NAN" << "\n";
    cout << "The coth is: " << "NAN" << "\n\n";
    cout << "The asinh is: " << "NAN" << "\n";
    cout << "The acosh is: " << "NAN" << "\n";
    cout << "The atanh is: " << "NAN" << "\n";
    cout << "The acsch is: " << "NAN" << "\n";
    cout << "The asech is: " << "NAN" << "\n";
    cout << "The acoth is: " << "NAN" << "\n";
    cout << "The complex number rotated by pi/6 radians is: " << rotate(a, PI/6) << "\n";
}

//build library:
//gcc -c -o out.o complasa_runner.cpp
